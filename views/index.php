...
<form action="<?php echo get_url( 'plugin/csv_import' ); ?>" method="POST">
    ...
    <div class="buttons">
        <?php if ( isset( $_POST['preview'] ) ): ?>
            ...
            <input type="submit" name="import" onclick="javascript:if(confirm('<?php echo __( 'Are you sure you want to import table with these settings?' ); ?>') !== true) {return false;}" value="<?php echo __( 'Import' ); ?>" />
